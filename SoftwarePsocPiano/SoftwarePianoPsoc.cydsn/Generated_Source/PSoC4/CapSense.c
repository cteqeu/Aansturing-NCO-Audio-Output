...
reg32 * CapSense_pcTable[] = {
    ...
    (reg32 *)CapSense_Sns__Button10__BTN__PC, 
    (reg32 *)CapSense_Sns__Button11__BTN__PC, 
    (reg32 *)CapSense_Sns__Button12__BTN__PC, 
};
...
const uint8 CapSense_portTable[] = {
    ...
    CapSense_Sns__Button10__BTN__PORT, 
    CapSense_Sns__Button11__BTN__PORT, 
    CapSense_Sns__Button12__BTN__PORT, 
};
...
const uint32 CapSense_maskTable[] = {
    ...
    CapSense_Sns__Button10__BTN__MASK, 
    CapSense_Sns__Button11__BTN__MASK, 
    CapSense_Sns__Button12__BTN__MASK, 
};
...
const uint8 CapSense_pinShiftTbl[] = {
    ...
    (uint8) CapSense_Sns__Button10__BTN__SHIFT, 
    (uint8) CapSense_Sns__Button11__BTN__SHIFT, 
    (uint8) CapSense_Sns__Button12__BTN__SHIFT, 
};
