...
void I2C_EzI2CSetAddress1(uint32 address)
{
    #if(I2C_SECONDARY_ADDRESS_ENABLE)
    {
        ...
        I2C_RX_MATCH_REG = I2C_EzI2CUpdateRxMatchReg(address,
                                                                               (uint32) I2C_addrBuf2);
    }
    #else
    {
        ...
        matchReg |= ((uint32)  I2C_GET_I2C_8BIT_ADDRESS(address)); /* Set mask */
...
void I2C_EzI2CSetReadBoundaryBuffer1(uint32 rwBoundary)
{
    ...
    *******************************************************************************/
    void I2C_EzI2CSetAddress2(uint32 address)
    {
        ...
        I2C_RX_MATCH_REG = I2C_EzI2CUpdateRxMatchReg((uint32) I2C_addrBuf1,
                                                                               address);
    }
