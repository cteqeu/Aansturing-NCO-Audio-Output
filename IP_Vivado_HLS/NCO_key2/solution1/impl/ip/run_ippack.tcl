...
set IPName      "NCO2"
set Version     "1.0"
set DisplayName "Nco2"
set Revision    "1706121248"
...
set Interfaces {
    s_axi_AXILiteS {
        ...
        registers {{0x10 freqControl W 0x0 "Data signal of freqControl" {{0 32 freqControl W 0 "Bit 31 to 0 Data signal of freqControl"}}} {0x18 sine_out_V R 0x0 "Data signal of sine_out_V" {{0 24 sine_out_V R 0 "Bit 23 to 0 Data signal of sine_out_V"} {24 8 RESERVED R 0 "Reserved.  0s on read."}}} {0x1c sine_out_V_ctrl R 0x0 "Control signal of sine_out_V" {{0 1 sine_out_V_ap_vld R 0 "Control signal sine_out_V_ap_vld"} {1 31 RESERVED R 0 "Reserved.  0s on read."}}}}
        memories ""
        ctype {
            AWVALID {
                Type "bool"
...
set enable_xo_gen 0
set kernel_files {C:/Users/11401393/Desktop/NCO_audio_output/IP_Vivado_HLS/NCO_key2/nco2.cpp}
if {$enable_xo_gen} {
