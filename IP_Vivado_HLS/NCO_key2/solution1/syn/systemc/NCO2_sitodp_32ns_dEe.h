...
#ifndef __NCO2_sitodp_32ns_dEe__HH__
#define __NCO2_sitodp_32ns_dEe__HH__
...
template<
    ...
    int din0_WIDTH,
    int dout_WIDTH>
SC_MODULE(NCO2_sitodp_32ns_dEe) {
    ...
    SC_CTOR(NCO2_sitodp_32ns_dEe):  ACMP_sitodp_U ("ACMP_sitodp_U") {
