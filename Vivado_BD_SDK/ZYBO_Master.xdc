...
#je
#set_property -dict { PACKAGE_PIN W16    IOSTANDARD LVCMOS33 } [get_ports { iic_rtl_scl_io }]; #IO_L18N_T2_34 Sch=JE2
#set_property -dict { PACKAGE_PIN J15    IOSTANDARD LVCMOS33 } [get_ports { iic_rtl_sda_io }]; #IO_25_35 Sch=JE3