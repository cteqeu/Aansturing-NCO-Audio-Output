...
proc create_root_design { parentCell } {
  ...
  # Create instance: NCO2, and set properties
  set NCO2 [ create_bd_cell -type ip -vlnv xilinx.com:hls:NCO2:1.0 NCO2 ]

  set_property -dict [ list \
CONFIG.NUM_READ_OUTSTANDING {1} \
CONFIG.NUM_WRITE_OUTSTANDING {1} \
 ] [get_bd_intf_pins /NCO2/s_axi_AXILiteS]
...
CONFIG.PCW_MIO_TREE_SIGNALS {gpio[0]#qspi0_ss_b#qspi0_io[0]#qspi0_io[1]#qspi0_io[2]#qspi0_io[3]#qspi0_sclk#gpio[7]#qspi_fbclk#gpio[9]#scl#sda#gpio[12]#gpio[13]#gpio[14]#gpio[15]#tx_clk#txd[0]#txd[1]#txd[2]#txd[3]#tx_ctl#rx_clk#rxd[0]#rxd[1]#rxd[2]#rxd[3]#rx_ctl#data[4]#dir#stp#nxt#data[0]#data[1]#data[2]#data[3]#clk#data[5]#data[6]#data[7]#clk#cmd#data[0]#data[1]#data[2]#data[3]#reset#cd#tx#rx#gpio[50]#gpio[51]#mdc#mdio} \
...
CONFIG.NUM_MI {4} \
  ...
  connect_bd_intf_net -intf_net ps7_0_axi_periph_M00_AXI [get_bd_intf_pins NCO2/s_axi_AXILiteS] [get_bd_intf_pins ps7_0_axi_periph/M00_AXI]
  ...
  connect_bd_net -net rst_ps7_0_100M_peripheral_aresetn [get_bd_pins NCO2/ap_rst_n] [get_bd_pins axi_gpio_0/s_axi_aresetn] [get_bd_pins ps7_0_axi_periph/M00_ARESETN] [get_bd_pins ps7_0_axi_periph/M01_ARESETN] [get_bd_pins ps7_0_axi_periph/M02_ARESETN] [get_bd_pins ps7_0_axi_periph/M03_ARESETN] [get_bd_pins ps7_0_axi_periph/S00_ARESETN] [get_bd_pins rst_ps7_0_100M/peripheral_aresetn] [get_bd_pins zybo_audio_ctrl_0/S_AXI_ARESETN]
  ...
  create_bd_addr_seg -range 0x00008000 -offset 0x43C00000 [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs NCO2/s_axi_AXILiteS/Reg] SEG_NCO2_Reg
...
preplace port PBLRCLK -pg 1 -y 660 -defaultsOSRD
preplace port BCLK -pg 1 -y 640 -defaultsOSRD
preplace port RECDAT -pg 1 -y 660 -defaultsOSRD
preplace port FIXED_IO -pg 1 -y 80 -defaultsOSRD
preplace port IIC_1 -pg 1 -y 100 -defaultsOSRD
preplace port PBDATA -pg 1 -y 700 -defaultsOSRD
preplace port FCLK_CLK1 -pg 1 -y 260 -defaultsOSRD
preplace port RECLRCLK -pg 1 -y 680 -defaultsOSRD
preplace port GPIO -pg 1 -y 400 -defaultsOSRD
preplace inst axi_gpio_0 -pg 1 -lvl 3 -y 390 -defaultsOSRD
preplace inst NCO2 -pg 1 -lvl 3 -y 520 -defaultsOSRD
preplace inst ps7_0_axi_periph -pg 1 -lvl 2 -y 400 -defaultsOSRD
preplace inst zybo_audio_ctrl_0 -pg 1 -lvl 3 -y 680 -defaultsOSRD
...
preplace netloc processing_system7_0_DDR 1 3 1 1090J
preplace netloc ps7_0_axi_periph_M02_AXI 1 2 1 650
preplace netloc processing_system7_0_M_AXI_GP0 1 1 3 370 0 NJ 0 1080
preplace netloc rst_ps7_0_100M_peripheral_aresetn 1 1 2 370 610 680
preplace netloc processing_system7_0_FCLK_RESET0_N 1 0 4 30 660 NJ 660 690J 590 1070
preplace netloc processing_system7_0_IIC_1 1 3 1 1090J
preplace netloc ps7_0_axi_periph_M01_AXI 1 2 1 660
preplace netloc processing_system7_0_FIXED_IO 1 3 1 1090J
preplace netloc zybo_audio_ctrl_0_RECLRCLK 1 3 1 1080J
preplace netloc axi_gpio_0_GPIO 1 3 1 1090J
preplace netloc zybo_audio_ctrl_0_PBLRCLK 1 3 1 1080J
preplace netloc zybo_audio_ctrl_0_BCLK 1 3 1 1080J
preplace netloc processing_system7_0_FCLK_CLK0 1 0 4 30 160 360 160 670 320 1080
preplace netloc ps7_0_axi_periph_M00_AXI 1 2 1 640
preplace netloc processing_system7_0_FCLK_CLK1 1 3 1 1090J
preplace netloc RECDAT_1 1 0 3 20J 670 NJ 670 NJ
preplace netloc zybo_audio_ctrl_0_PBDATA 1 3 1 1080J
preplace netloc rst_ps7_0_100M_interconnect_aresetn 1 1 1 350
levelinfo -pg 1 0 190 510 880 1110 -top -10 -bot 760
",
}
